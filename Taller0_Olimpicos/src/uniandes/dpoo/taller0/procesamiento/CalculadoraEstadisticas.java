...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retornar nombre del pais dado el atleta
	 */
	public String encontrarPaisAtleta(String nombreAtleta) 
	{
		String pais = "pais no encontrado";
		for (Atleta atleta : atletas) 
		{
			if (atleta.darNombre().equalsIgnoreCase(nombreAtleta)) 
			{
				pais=atleta.darPais().darNombre();
				//pais="Nombre encontrado";
				//pais=atleta.pais.darNombre();
				//pais=atleta.darPais();	
			}
		}
		return pais;
