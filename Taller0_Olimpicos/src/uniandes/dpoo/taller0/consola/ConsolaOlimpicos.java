...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar informaci�n de un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}

	/**
	 * Muestra la informaci�n de un atleta 
	 */
	private void ejecutarAtletaInfo() 
	{
		System.out.println("\n + Informaci�n de Atleta" + "\n");
		
		String name = input("Por favor ingrese el nombre del atleta a ver");
		if (name!=null)
		{
			String paisAtleta = calculadora.encontrarPaisAtleta(name); //OJO
			System.out.println("El pais de "+name+" es: "+paisAtleta);
		}
		else 
		{
